...
Reducer<TrackingsState> trackingReducer = combineReducers(
  <Reducer<TrackingsState>>[
    TypedReducer<TrackingsState, UpdateTrackingInfo>(_updateTrackingInfo),
    TypedReducer<TrackingsState, TrackActionSuccessful>(_trackActionSuccessful),
  ],
);
